...
function initNavGesture() {
  ...
  function onMove(x) {
    ...
    const ind = getIndicator();
    if (ind) { ind.style.left = left + 'px'; ind.style.width = btnW + 'px'; }
  ...
  nav.addEventListener('touchstart', e => {
    startX = e.touches[0].clientX; isDragging = false; didDrag = false;
  }, { passive: true });
  ...
  nav.addEventListener('touchcancel', endDrag, { passive: true });
